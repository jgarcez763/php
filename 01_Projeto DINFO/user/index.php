<?php 
    ...
    if(isset($_GET['esconder'])){
        $hide = "AND dtConcEfet IS NULL";
        
        $icon = "<a href='./?id=$id'> <img src='../eye-off.svg' alt='show' class='showFilter'> </a>";
        
    }else{
        $hide = "";
        $icon = "<a href='./?id=$id&esconder'> <img src='../eye.svg' alt='show' class='showFilter'> </a>";
    }
...
<div id="atividades-container">
    ...
    <?php
        $Result_Tbatividade = "SELECT * FROM tabela_atividades_projeto WHERE Fk_ID_Usuario = $id $hide ORDER BY dtConcPrev ASC";
